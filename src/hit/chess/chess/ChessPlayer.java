...
public class ChessPlayer extends Player {
    ...
    public static ArrayList<ChessPlayer> fetch_players()         //Function to fetch the list of the players
    {
        ChessPlayer tempplayer;
        ...
        try
        {
            ...
            try
            {
                while(true)
                {
                    tempplayer = (ChessPlayer) input.readObject();
        ...
        try
        {
            ...
            else
            {
                ...
                try
                {
                    while(true)
                    {
                        temp_player = (ChessPlayer)input.readObject();
