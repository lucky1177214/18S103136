...
import hit.chess.chess.ChessAction;
...
public class ChessGame implements Game {
    ...
    @Override public void initGame(){
        ...
        System.out.println("Please Input name of player1:");
        player1Name = scanner1.nextLine();
        System.out.println("Please input name of player2:");
    ...
    @Override public void menu(){
        ...
        System.out.println("1-------Move the piece");
        System.out.println("2-------Remove the piece");
